...
class insertion_ordered_map {
 private:
  ...
  shared_ptr<my_unordered_map> map; // map giving an iterator to list element for a key
  bool need_for_copy; // if there was an element referenced, we cannot copy any more
